...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function addFeaturedItem (container, size, ownshipStatus, price, discount, installment, landType, imgBg) {
      ...
      const agentBtn = featuredIt.querySelectorAll(".agent-contact button")[0];
      ...
      imageBtn.onclick = function () {
        ...
        overlay.innerHTML = `
            <div class="overlay-content">
                ...
                <div class='quote-overlay-display'></div>
            </div>`;
        ...
        const quoteOverlay = overlay.querySelector('.overlay-content .quote-overlay-display');
        const randomQuote = Math.floor(Math.random() * landQuotes.length);

        quoteOverlay.innerHTML = `<p>${landQuotes[randomQuote]}</p>`;
